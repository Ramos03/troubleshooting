...
<p>Eu <span class="font-weight-bold">{!! $customer->name!!}</span>, aceito o contrato tipo <span class="font-weight-bold">{!! $customer->contract->contractId !!}</span> sob as condições:</p>
